              ...
              >
                ...
                >
                  ...
                  <p className="text-gray-600">
                    {selectedStrategy === "strategy" && t("whatWeDo.strategy.description")}
                    {selectedStrategy === "content" && t("whatWeDo.content.description")}
                    {selectedStrategy === "management" && t("whatWeDo.management.description")}
                  </p>
                </motion.div>
              </motion.div>
            )}
